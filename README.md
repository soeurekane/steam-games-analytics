...
Небольшое исследование игр в Steam: от сбора данных через API до базы SQLite, SQL-запросов и графиков.
...
Мне хотелось сделать не просто анализ готового датасета, а пройти весь путь работы с данными самостоятельно:

1. получить список игр через SteamSpy API;
2. собрать подробную информацию через Steam Store API;
3. найти дубликаты и пропуски;
4. привести даты и цены к единому формату;
5. разложить данные по связанным таблицам в SQLite;
6. провести анализ с помощью SQL и Python.
